...
--
-- Host: 127.0.0.1
-- Generation Time: 14 Apr 2022 pada 10.20
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
--
-- Struktur dari tabel `tb_siswakelas`
--

CREATE TABLE IF NOT EXISTS `tb_siswakelas` (
...
--
-- Dumping data untuk tabel `tb_siswakelas`
--

INSERT INTO `tb_siswakelas` (`id_siswakelas`, `kelas`, `siswa`) VALUES
(17, 1, 11),
(18, 1, 12),
(19, 1, 13),
(20, 1, 14),
...
--
-- Indexes for table `tb_siswakelas`
--
ALTER TABLE `tb_siswakelas`
...
--
-- AUTO_INCREMENT for table `tb_siswakelas`
--
ALTER TABLE `tb_siswakelas`
MODIFY `id_siswakelas` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
