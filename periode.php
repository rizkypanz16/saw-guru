...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="container-fluid mt-2 col-10">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><strong>Form Tambah Periode Penilaian</strong></h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text lead" style="font-size: 15px;"><strong>Tambah Periode Penilaian Guru Disini</strong></p>
                            <form action="http://localhost/saw/proses/input_periode.php" method="post" class="pb-4">
                                <div class="form-group mb-0">
                                    <!-- username -->
                                    <label for="periode" style="font-size: 13px;">Nama Periode </label>
                                    <input type="text" name="periode" class="form-control form-control-sm">
                                </div>

                                <div class="form-group mb-0">
                                    <!-- username -->
                                    <label for="tgl_periode" style="font-size: 13px;">Tanggal Penilaian </label>
                                    <input type="date" name="tgl_periode" class="form-control form-control-sm">
                                </div>
                ...
                <div class="col">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-header">
                                <h5 class="card-title"><strong>Daftar Periode Penilaian</strong></h5>
                            </div>
                            <div class="card-body">
                                <table class="table" id="dataTable">
                                    ...
                                    include 'koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "select * from tb_periode");
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo date('Y-m-d', strtotime($d['tgl_periode'])); ?></td>
                                                <!-- <td><a href="http://localhost/saw/proses/hapus_periode.php?id_periode=<?= $d['id_periode'] ?>" class="btn btn-sm btn-danger">hapus</a></td> -->
                                                <td>
                                                    <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#myModaledit<?= $d['id_periode'] ?>"><i class="fas fa-edit"></i></button>
                                                    <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#myModal<?= $d['id_periode'] ?>"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
            ...
            ?>
                <!-- Modal -->
                <div id="myModal<?= $d['id_periode'] ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="http://localhost/saw/proses/hapus_periode.php">
                                    <p class="lead">Apakah Anda Yakin Akan Menghapus Data ?</p>
                                    <input type="hidden" name="id_periode" value="<?= $d['id_periode'] ?>">
                            </div>
            ...
            ?>
                <!-- Modal -->
                <div id="myModaledit<?= $d['id_periode'] ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="http://localhost/saw/proses/update_periode.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id_periodei" value="<?= $d['id_periode'] ?>">
                                    <label for="user" class="label">Periode</label>
                                    <input type="text" name="periodei" value="<?= $d['nama_periode'] ?>" class="form-control">
                                    <label for="user" class="label">Tanggal</label>
                                    <input type="date" name="tanggali" value="<?= $d['tgl_periode'] ?>" class="form-control">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
