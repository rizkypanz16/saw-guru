...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="container-fluid mt-2 col-10">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><strong>Form Tambah Kelas</strong></h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text lead" style="font-size: 18px;"><strong>Tambah Kelas Disini</strong></p>
                            <form action="http://localhost/saw/proses/input_kelas.php" method="post" class="pb-4">

                                <div class="form-group mb-0">
                                    <!-- username -->
                                    <label for="kelas" style="font-size: 15px;">Nama Kelas </label>
                                    <input type="text" name="kelas" class="form-control form-control-md">
                                </div>
                ...
                <div class="col">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-header">
                                <h5 class="card-title"><strong>Daftar Kelas Terdaftar</strong></h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <!-- <td><a href="http://localhost/saw/proses/hapus_kelas.php?id_kelas=<?= $d['id_kelas'] ?>" class="btn btn-sm btn-danger">hapus</a></td> -->

                                                <td>
                                                    <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#myModaledit<?= $d['id_kelas'] ?>"><i class="fas fa-edit"></i></button>
                                                    <button type="button" class="btn btn-sm" data-toggle="modal" data-target="#myModal<?= $d['id_kelas'] ?>"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
            ...
            ?>
                <!-- Modal -->
                <div id="myModal<?= $d['id_kelas'] ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="http://localhost/saw/proses/hapus_kelas.php">
        ...
        ?>
            <!-- Modal -->
            <div id="myModaledit<?= $d['id_kelas'] ?>" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="http://localhost/saw/proses/update_kelas.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_kelasi" value="<?= $d['id_kelas'] ?>">
                                <label for="user" class="label">Nama Kelas</label>
                                <input type="text" name="kelasi" value="<?= $d['nama_kelas'] ?>" class="form-control">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
